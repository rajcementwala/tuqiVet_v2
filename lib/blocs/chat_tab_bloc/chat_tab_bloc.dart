...
import 'chat_tab_contract.dart';

class ChatTabBloc extends BaseBloc<ChatTabEvent, ChatTabData> {
  ChatTabBloc(this._errorHandler, this._eventBus, this._preferenceStore)
      : super(initState) {
  ...
  static ChatTabData get initState => (ChatTabDataBuilder()
